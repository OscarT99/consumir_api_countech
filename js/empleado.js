...
const listarDatos= async()=>{
    ...
    .then(function(data){
        ...
        return listaEmpleados.map(function(empleado){
          ...
          const formattedFechaIngreso = fechaIngreso.toISOString().split('T')[0];
            ...
            `<td><button type="button"   data-bs-toggle="modal"  data-bs-target="#exampleModal" onclick='editar(${JSON.stringify(empleado)})'><i class="fa-solid fa-user-pen fa-lg" style="color: #000000;"></i></button></td>
            <td><a href='#'  onclick='eliminar(${JSON.stringify(empleado)})' type="button"><i class="fa-solid fa-trash fa-xl" style="color: #940000;"></i></a></td></tr>`
   ...
   /* const registrar = async() =>{
    ...
    const editar = (empleado) => {
        ...
        const fechaIngreso = new Date(empleado.fechaIngreso);
        const formattedFechaIngreso = fechaIngreso.toISOString().split('T')[0];
        document.getElementById('fechaIngreso').value = formattedFechaIngreso;
